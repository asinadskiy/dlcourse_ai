    ...
    def fit(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            for batch_indices in batches_indices:
                ...
                # the params
                batch_X = self.dataset.train_X[batch_indices] # выбираем данные
                target_index = self.dataset.train_y[batch_indices] # выбираем ответы для данныъ
                loss = self.model.compute_loss_and_gradients(batch_X, target_index) # и вычисляем по ним градиент
            ...
            if np.not_equal(self.learning_rate_decay, 1.0):
                ...
                self.learning_rate *= self.learning_rate_decay # уменьшаем скорость обучения
